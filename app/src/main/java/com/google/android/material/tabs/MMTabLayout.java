 ...
 */
@ViewPager.DecorView
public class MMTabLayout extends HorizontalScrollView {
    ...
    /**
     * Gravity used to fill the {@link MMTabLayout} as much as possible. This option only takes effect
    ...
    /**
     * Gravity used to lay out the tabs in the center of the {@link MMTabLayout}.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
    ...
    public MMTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MMTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    /**
     * Returns the current mode used by this {@link MMTabLayout}.
     *
     * @see #setTabMode(int)
     */
    @Mode
    ...
    /**
     * The one-stop shop for setting up this {@link MMTabLayout} with a {@link ViewPager}.
     * <p>
     ...
     * necessary calls back to the provided {@link MMTabLayout} so that the tab position is
     * kept in sync.
     * <p>
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<MMTabLayout> mTabLayoutRef;
        private int mPreviousScrollState;
        private int mScrollState;

        public TabLayoutOnPageChangeListener(MMTabLayout tabLayout) {
        ...
        public void onPageScrolled(final int position, final float positionOffset,
            ...
            final MMTabLayout tabLayout = mTabLayoutRef.get();
            if (tabLayout != null) {
    ...
    public static abstract class TabInfo {
        ...
        @NonNull
        protected abstract View inflateCustomView(@NonNull MMTabLayout tabLayout);

        @NonNull
        public View getCustomView(@NonNull MMTabLayout tabLayout) {
            if (customView == null) {
        ...
        protected abstract void onAnimatorUpdate(@NonNull MMTabLayout tabLayout,
                                                 @NonNull View customView, float percent);

        void onAnimatorUpdate(MMTabLayout tabLayout, int position, float percent) {
