...
public class MomoTabLayout extends HorizontalScrollView {
    ...
    /**
     * Gravity used to fill the {@link MomoTabLayout} as much as possible. This option only takes effect
    ...
    /**
     * Gravity used to lay out the tabs in the center of the {@link MomoTabLayout}.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
    ...
    public MomoTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MomoTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    /**
     * Add a {@link MomoTabLayout.OnTabSelectedListener} that will be invoked when tab selection
     * changes.
     * <p>
    ...
    /**
     * Remove the given {@link MomoTabLayout.OnTabSelectedListener} that was previously added via
    ...
    /**
     * Remove all previously added {@link MomoTabLayout.OnTabSelectedListener}s.
     */
    ...
    /**
     * Returns the current mode used by this {@link MomoTabLayout}.
     *
     * @see #setTabMode(int)
     */
    @Mode
    ...
    /**
     * The one-stop shop for setting up this {@link MomoTabLayout} with a {@link ViewPager}.
     * <p>
    ...
    private class SlidingTabStrip extends ViewGroup {
        ...
        private void updateTab(int position, float percent) {
                ...
                animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    ...
                    public void onAnimationUpdate(ValueAnimator animator) {
                        ...
                        setIndicatorPosition(
                                AnimationUtils.lerp(startLeft, targetView.getLeft(), fraction),
                                AnimationUtils.lerp(startRight, targetView.getRight(), fraction));
                        if (!isSameTab) {
     ...
     * necessary calls back to the provided {@link MomoTabLayout} so that the tab position is
     * kept in sync.
     * <p>
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<MomoTabLayout> mTabLayoutRef;
        private int mPreviousScrollState;
        private int mScrollState;

        public TabLayoutOnPageChangeListener(MomoTabLayout tabLayout) {
        ...
        public void onPageScrolled(final int position, final float positionOffset,
            ...
            final MomoTabLayout tabLayout = mTabLayoutRef.get();
            if (tabLayout != null) {
    ...
    /**
     * A {@link MomoTabLayout.OnTabSelectedListener} class which contains the necessary calls back
     * to the provided {@link ViewPager} so that the tab position is kept in sync.
     */
    public static class ViewPagerOnTabSelectedListener implements MomoTabLayout.OnTabSelectedListener {
    ...
    public static abstract class TabInfo {
        ...
        protected void inheritTabLayoutStyle(@NonNull TextView textView,
                                             @NonNull MomoTabLayout tabLayout) {
        ...
        @NonNull
        protected abstract View inflateCustomView(@NonNull MomoTabLayout tabLayout);

        @NonNull
        public View getCustomView(@NonNull MomoTabLayout tabLayout) {
            if (customView == null) {
        ...
        protected abstract void onAnimatorUpdate(@NonNull MomoTabLayout tabLayout,
                                                 @NonNull View customView, float percent);

        void onAnimatorUpdate(MomoTabLayout tabLayout, int position, float percent) {
