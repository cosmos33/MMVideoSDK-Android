...
import com.immomo.videosdk.base.tabinfo.DefaultSlidingIndicator;
...
public abstract class BaseScrollTabGroupFragment extends BaseTabOptionFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tabLayout.setTabMode(MomoTabLayout.MODE_SCROLLABLE);
    ...
    protected void onLoad() {
        ...
        for (int i = 0; i < tabs.size(); i++) {
            ...
            MomoTabLayout.Tab tab = tabLayout.getTabAt(i);
            if (tab != null) {
