...
import com.immomo.videosdk.recorder.view.IMomoRecordView;
...
public class RecordPresenter implements IRecorder, SurfaceHolder.Callback, IMomoRecorder {
    ...
    public RecordPresenter() {
        multiRecorder = MoMediaManager.createRecorder(null);
    }
    ...
    public void surfaceDestroyed(SurfaceHolder holder) {
        MDLog.d(LogTag.RECORDER.RECORD, "surfaceDestroyed");
        mHolder = null;
        stopPreview();
    ...
    public void takePhoto() {
        ...
        if (multiRecorder != null) {
            ...
            try {
                ...
                try {
                    multiRecorder.resetCamera(activity);
    ...
    public void setItemSelectSkinLevel(float[] value) {
        multiRecorder.setSkinLevel(value);
    }
    ...
    public void switchCamera() {
        ...
        multiRecorder.switchCamera(activity);
    ...
    public void startPreview() {
        multiRecorder.setDoFaceDetect(isOpenFaceDetect());
        if (!isSurfaceCreated) {
            return;
        }
