...
import com.immomo.videosdk.bean.MomentFacePanelElement;
import com.immomo.videosdk.bean.MomentFacePanelHelper;
import com.immomo.videosdk.bean.TolerantMoment;
import com.immomo.videosdk.bean.VideoInfoTransBean;
import com.immomo.videosdk.bean.element.Element;
import com.immomo.videosdk.bean.element.ElementManager;
...
import com.immomo.videosdk.recorder.helper.MomentFaceConstants;
import com.immomo.videosdk.recorder.helper.MomentFaceUtil;
import com.immomo.videosdk.recorder.helper.MomoRecorderProxy;
...
import com.immomo.videosdk.recorder.listener.RecordOrientationSwitchListener;
...
import com.immomo.videosdk.recorder.presenter.IRecorder;
import com.immomo.videosdk.recorder.presenter.RecordPresenter;
import com.immomo.videosdk.utils.AnimUtils;
import com.immomo.videosdk.utils.AnimationUtil;
import com.immomo.videosdk.utils.DeviceUtils;
import com.immomo.videosdk.utils.MomentUtils;
import com.immomo.videosdk.utils.NewAnimUtils;
import com.immomo.videosdk.utils.RecordButtonTouchEventHelper;
import com.immomo.videosdk.utils.ScreenOrientationManager;
import com.immomo.videosdk.utils.UIUtils;
import com.immomo.videosdk.utils.VideoUtils;
import com.immomo.videosdk.utils.XEngineEventHelper;
import com.immomo.videosdk.utils.album.AlbumConstant;
import com.immomo.videosdk.utils.filter.FiltersManager;
import com.immomo.videosdk.widget.FaceTipView;
import com.immomo.videosdk.widget.FilterScrollMoreViewPager;
import com.immomo.videosdk.widget.MomentFilterPanelLayout;
import com.immomo.videosdk.widget.MomentFilterPanelTabLayout;
import com.immomo.videosdk.widget.MomentRecordProgressView;
import com.immomo.videosdk.widget.MomentSkinAndFacePanelLayout;
import com.immomo.videosdk.widget.OrientationTextView;
import com.immomo.videosdk.widget.RecordPageIndicator;
import com.immomo.videosdk.widget.ScrollMoreViewPager;
import com.immomo.videosdk.widget.SlideIndicatorBar;
import com.immomo.videosdk.widget.SlideIndicatorBuilder;
import com.immomo.videosdk.widget.VideoAdvancedRecordButton;
import com.immomo.videosdk.widget.VideoDefaultRecordButton;
import com.immomo.videosdk.widget.VideoRecordControllerLayout;
...
public class VideoRecordFragment extends BaseFragment implements IMomoRecordView, View.OnClickListener, FilterSelectListener {
    ...
    private void switchDelete() {
        if (videoAdvancedBtnDelete.isActivated()) {
            ...
            //需要告诉 recorder删除
            //https://www.fabric.io/momo6/android/apps/com.immomo.momo/issues/58d2c9c80aeb16625bb6fa1a?time=last-seven-days
            if (mPresenter != null) {
                mPresenter.removeLast();
            } else {
