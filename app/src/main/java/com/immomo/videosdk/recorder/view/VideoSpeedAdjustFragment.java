...
import com.immomo.videosdk.widget.seekbar.OnSeekChangeListener;
import com.immomo.videosdk.widget.seekbar.SeekParams;
import com.immomo.videosdk.widget.seekbar.TickSeekBar;
...
import com.immomo.videosdk.utils.UIHandler;
...
public class VideoSpeedAdjustFragment extends BaseFragment implements View.OnClickListener {
    ...
    private static final int ONE_MINITE = MediaConstants.ONE_MINUTE + MediaConstants.MOMENT_DURATION_EXPAND;
    ...
    private void startPlay(long start, long end, float speed, boolean isResume) {
        ...
        Log4Android.getInstance().i("startPlay json:" + json);
        //先暂停
        //        pausePlay();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.video_Speed_surface_placeholder:
                if (process != null) {
                ...
                break;
            case R.id.moment_speed_btn_close:
                onCancel();
                break;
            case R.id.video_speed_bottom_layout:
                break;
            case R.id.moment_speed_btn_ok:
                onFinished();
                break;
            default:
                break;
