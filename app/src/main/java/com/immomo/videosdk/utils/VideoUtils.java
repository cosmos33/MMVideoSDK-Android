...
public class VideoUtils {
    ...
    private static final int MAX_ANDROID_4_4_SIZE = 480;
    private static final int MAX_ANDROID_4_4_MAX_SIZE = 640;
    private static final int MAX_ANDROID_4_4_PX = MAX_ANDROID_4_4_SIZE * MAX_ANDROID_4_4_MAX_SIZE;
    private static final int MAX_ANDROID_SIZE = 720;
    private static final int MAX_ANDROID_MAX_SIZE = 1280;
    private static final int MAX_ANDROID_PX = MAX_ANDROID_SIZE * MAX_ANDROID_MAX_SIZE;
    ...
    public static final int[] getMaxVideoSize() {
        int result[] = new int[]{MAX_ANDROID_SIZE, MAX_ANDROID_MAX_SIZE};
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            result[0] = MAX_ANDROID_4_4_SIZE;
            result[1] = MAX_ANDROID_4_4_MAX_SIZE;
        }
        return result;
    }
