package com.immomo.videosdk.utils.toolbar;
 ...
 * Project momodev
 * Package com.immomo.momo.view.toolbar
...
public class ToolbarHelper {
    ...
    /**
     * 在Toolbar右边增加菜单按钮,按钮的点击事件在 {@link androidx.appcompat.widget.Toolbar.OnMenuItemClickListener} 中处理
     *
     * @param itemId
     * @param itemText
