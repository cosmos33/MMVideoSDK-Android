...
import com.mm.sdkdemo.recorder.editor.image_composition_video.view.ILivePhotoPresenter;
...
import com.mm.sdkdemo.recorder.model.EmptyItemModel;
    ...
    private void updateLivePhotoAnimate(@NonNull LiveAnimate liveAnimate) {
        ...
        switch (liveAnimate.getAnimateType()) {
            ...
            case LiveAnimate.AnimateType.ANIMATE_SHOW: {
                mFieldGroupFilterChooser.setLookupPath(LivePhotoUtil.getLivePhotoHomeDir() + "/show/Lookup");
