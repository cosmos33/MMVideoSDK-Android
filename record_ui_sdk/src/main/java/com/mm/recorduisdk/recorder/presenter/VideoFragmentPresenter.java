...
public class VideoFragmentPresenter extends BaseAlbumPresenter {
    ...
    public VideoFragmentPresenter(@NonNull IAlbumFragment<VideoFragment> fragment, @NonNull MMChooseMediaParams conditions) {
    ...
    public List<CementModel<?>> getModels(AlbumDirectory albumDirectory) {
        ...
        for (int i = 0; i < length; i++) {
            models.add(new AlbumItemModel(mFragment, mConditions, photos.get(i), needShowImage, imageSize, i));
        }
        return models;
    }
