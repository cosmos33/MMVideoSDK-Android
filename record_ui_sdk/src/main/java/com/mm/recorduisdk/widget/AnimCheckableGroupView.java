    ...
    private void initStyle(TypedArray appearance) {
        if (appearance != null) {
            ...
            for (int i = 0; i < len; i++) {
                ...
                if (attr == R.styleable.AnimCheckableGroupView_acgv_orientation) {
                    setOrientation(appearance.getInt(attr, orientation));

                } else if (attr == R.styleable.AnimCheckableGroupView_acgv_show_anim_duration) {
                    setShowAnimDuration(appearance.getInt(attr, showAnimDuration));

                } else if (attr == R.styleable.AnimCheckableGroupView_acgv_show_anim_delay) {
                    setShowAnimDelay(appearance.getInt(attr, showAnimDelay));

                } else if (attr == R.styleable.AnimCheckableGroupView_acgv_check_anim_duration) {
                    setCheckAnimDuration(appearance.getInt(attr, checkAnimDuration));

                } else if (attr == R.styleable.AnimCheckableGroupView_acgv_padding) {
                    final int p = appearance.getDimensionPixelOffset(attr, 0);
                    params.padding.set(p, p, p, p);
                } else if (attr == R.styleable.AnimCheckableGroupView_acgv_padding_left) {
                    params.padding.set(
                ...
                } else if (attr == R.styleable.AnimCheckableGroupView_acgv_padding_top) {
                    params.padding.set(
                            params.padding.left,
                            appearance.getDimensionPixelOffset(attr, 0),
                            params.padding.right,
                ...
                } else if (attr == R.styleable.AnimCheckableGroupView_acgv_padding_right) {
                    params.padding.set(
                            params.padding.left,
                            params.padding.top,
                            appearance.getDimensionPixelOffset(attr, 0),
                ...
                } else if (attr == R.styleable.AnimCheckableGroupView_acgv_padding_bottom) {
                    params.padding.set(
                            params.padding.left,
                            params.padding.top,
                            params.padding.right,
