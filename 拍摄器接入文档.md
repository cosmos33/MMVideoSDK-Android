...
project build.gradle 中添加 jcenter 仓库：
...
主 module build.gradle 中添加如下外部依赖

```java
	implementation 'com.cosmos.mediax:recorder:1.0.6'
	implementation 'com.cosmos.mediax:playersdk:1.1.6'
